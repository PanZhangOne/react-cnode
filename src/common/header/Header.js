...
class AppBarConponent extends Component {
    constructor(props) {
        super(props);
        this.state = {
            menuActive: false
            ...
            <div>
                ...
                <Drawer
                    ...
                    <Paper style={style} zDepth={1} rounded={false}>
                        <img style={{width: '100%', height: '100%',padding: '2rem', display: 'block', background: 'rgb(0, 188, 212)'}} src="https://cnodejs.org/public/images/cnodejs.svg" />
                    </Paper>
...
export default AppBarConponent;
